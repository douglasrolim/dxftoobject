...
class DxfParser extends EventEmitter{
    ...
    init(text){
        ...
        return new Promise(async function(resolve,reject){
            ...
            let entities = await _self.parser['ENTITIES'].parse()
            resolve({
               HEADER: await _self.parser['HEADER'].parse(),
               TABLES: await _self.parser['TABLES'].parse(),
               BLOCKS: await _self.parser['BLOCKS'].parse(),
               ENTITIES: await _self.parser['ENTITIES'].parse(),
                THUMBNAIL:await _self.parser['THUMBNAIL'].parse()
            })
        });
    }
